            ...
            <div class="row">
                <div id="page_content_editable"  class="editable span8">
                    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                        ...
                        ?>
                        <p><?php _e('Sorry, no post matches your criteria.', 'nimbus'); ?></p>
                        <?php endif; ?>
                    <h2>Pages</h2>
                    <ul>
                    ...
                    <ul>
                        ...
                        if (have_posts()) : while (have_posts()) : the_post();
                            ...
                            ?>
                            <li><?php _e('There are currently no posts on this website.', 'nimbus'); ?></li>
                        <?php
                        endif;
                        $wp_query = null;
                    ...
                    <ul>
                        ...
                        if (have_posts()) : while (have_posts()) : the_post();
                            ...
                            ?>
                            <li><?php _e('There are currently no portfolio items on this website.', 'nimbus'); ?></li>
                        <?php
                        endif;
                        $wp_query = null;
                        $wp_query = $original_query;
