        ...
        <div id="options_wrapper">
            <div id="options_header">	
                <img id="panel_logo" src="<?php echo OPTIONS_PATH; ?>images/nimbus-panel.jpg" alt='Nimbus Panel'  />	
                   <a href="http://www.nimbusthemes.com/?utm_source=wp_opulus&utm_medium=theme&utm_content=panel_banner&utm_campaign=opulus"><img id="panel_banner" src="<?php echo OPTIONS_PATH; ?>images/become-member.jpg" alt='Become a Member'  /></a>
            </div>
            <div id="options_content">	
                ...
                <div id="form_wrapper">
                    ...
                    <form action="options.php" method="post" id="nimbus_form">
                        ...
                        <div id="slideshow">
                            <?php echo $display_tab_content['slideshow']; ?>
                        </div>
                        <div id="blog">
                            <?php echo $display_tab_content['blog']; ?>
                        </div>
                        <div id="portfolio">
                            <?php echo $display_tab_content['portfolio']; ?>
                        </div>
                        <div id="design">
                        ...
                        <div id="seo">
                            <?php echo $display_tab_content['seo']; ?>
                        </div>
                        <div id="scripts">
                        ...
                        <div id="widgets">
                            <?php echo $display_tab_content['widgets']; ?>
                        </div> 
                        <div id="shortcodes">
                            <?php echo $display_tab_content['shortcodes']; ?>
                        </div> 
