...
<div class="row">
    <div id="frontpage_banner" class="span12 center none">
        ...
        <?php 
            ...
            ?>
                <img src="<?php echo get_template_directory_uri(); ?>/images/welcome-wp-opulus.jpg" class="attachment-full-banner wp-post-image" alt="Welcome Banner" />
            <?php
            } else {
                if ( has_post_thumbnail() ) {
                    ...
                    ?>
                        <img src="<?php echo get_template_directory_uri(); ?>/images/add-featured-img-wp-opulus.jpg" class="attachment-full-banner wp-post-image" alt="Reminder Banner" />
                    <?php    
                    }
                }
            }
